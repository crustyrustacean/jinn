use super::*;
use crate::actor::envelope::ActorEnvelope;

fn test_sink() -> Arc<dyn MessageSink> {
    Arc::new(crate::actor::message_sink::RecordingSink::new())
}

fn test_sink_as_concrete() -> Arc<crate::actor::message_sink::RecordingSink> {
    Arc::new(crate::actor::message_sink::RecordingSink::new())
}
