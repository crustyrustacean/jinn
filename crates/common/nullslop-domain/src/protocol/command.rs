...
mod tests {
    ...
    #[case::switch_prompt_strategy(Command::SwitchPromptStrategy { payload: SwitchPromptStrategy { session_id: SessionId::new(), strategy_id: crate::protocol::PromptStrategyId::sliding_window() } })]
    #[case::restore_strategy_state(Command::RestoreStrategyState { payload: RestoreStrategyState { session_id: SessionId::new(), strategy_id: crate::protocol::PromptStrategyId::compaction(), blob: serde_json::json!({}) } })]
    #[case::push_chat_entry(Command::PushChatEntry { payload: PushChatEntry { session_id: SessionId::new(), entry: crate::protocol::ChatEntry::user("hi") } })]
    ...
    #[case::register_tools(Command::RegisterTools { payload: RegisterTools { provider: "echo-actor".into(), definitions: vec![crate::protocol::ToolDefinition { name: "echo".into(), description: "echo".into(), parameters: serde_json::json!({}) }] } })]
    #[case::execute_tool_batch(Command::ExecuteToolBatch { payload: ExecuteToolBatch { session_id: SessionId::new(), tool_calls: vec![crate::protocol::ToolCall { id: "call_1".into(), name: "echo".into(), arguments: "{}".into() }] } })]
    #[case::execute_tool(Command::ExecuteTool { payload: ExecuteTool { session_id: SessionId::new(), tool_call: crate::protocol::ToolCall { id: "call_1".into(), name: "echo".into(), arguments: "{}".into() } } })]
    #[case::push_tool_result(Command::PushToolResult { payload: PushToolResult { session_id: SessionId::new(), result: crate::protocol::ToolResult { tool_call_id: "call_1".into(), name: "echo".into(), content: "hi".into(), success: true } } })]
    ...
    #[case::session_load_completed(Command::SessionLoadCompleted { payload: SessionLoadCompleted {
        ...
        title: "Test".to_owned(),
        history: vec![],
        active_strategy: crate::protocol::PromptStrategyId::passthrough(),
        blobs: std::collections::HashMap::new(),
    } })]
    #[case::pin_chat_entry(Command::PinChatEntry { payload: PinChatEntry { session_id: SessionId::new(), entry_id: crate::protocol::ChatEntryId::new(), position: crate::protocol::PinPosition::Top } })]
    #[case::unpin_chat_entry(Command::UnpinChatEntry { payload: UnpinChatEntry { session_id: SessionId::new(), entry_id: crate::protocol::ChatEntryId::new() } })]
    #[case::load_picker_entries(Command::LoadPickerEntries { payload: LoadPickerEntries { kind: crate::protocol::PickerKind::Provider } })]
    ...
    #[rstest::rstest]
    #[case::provider(crate::protocol::PickerKind::Provider, "provider")]
    #[case::context_assembly(crate::protocol::PickerKind::ContextAssembly, "context-assembly")]
    #[case::keymap(crate::protocol::PickerKind::Keymap, "keymap")]
    #[case::session(crate::protocol::PickerKind::Session, "session")]
    fn picker_kind_display(#[case] kind: crate::protocol::PickerKind, #[case] expected: &str) {
