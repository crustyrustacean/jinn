...
mod tests {
    ...
    fn event_chat_entry_submitted_preserves_entry() {
        ...
        match back {
            Event::ChatEntrySubmitted { payload } => {
                assert_eq!(
                    payload.entry.kind,
                    crate::protocol::ChatEntryKind::User("hello".to_owned())
                );
            }
    ...
    #[case::tool_call_received(Event::ToolCallReceived { payload: ToolCallReceived { session_id: SessionId::new(), tool_call: crate::protocol::ToolCall { id: "call_1".into(), name: "echo".into(), arguments: "{}".into() } } })]
    ...
    #[case::tool_batch_completed(Event::ToolBatchCompleted { payload: ToolBatchCompleted { session_id: SessionId::new(), results: vec![crate::protocol::ToolResult { tool_call_id: "call_1".into(), name: "echo".into(), content: "hi".into(), success: true }] } })]
    #[case::tool_execution_completed(Event::ToolExecutionCompleted { payload: ToolExecutionCompleted { session_id: SessionId::new(), result: crate::protocol::ToolResult { tool_call_id: "call_1".into(), name: "echo".into(), content: "hi".into(), success: true } } })]
    #[case::tools_registered(Event::ToolsRegistered { payload: ToolsRegistered { provider: "echo-actor".into(), definitions: vec![crate::protocol::ToolDefinition { name: "echo".into(), description: "echoes".into(), parameters: serde_json::json!({}) }] } })]
    ...
    #[case::prompt_strategy_switched(Event::PromptStrategySwitched { payload: PromptStrategySwitched { session_id: SessionId::new(), strategy_id: crate::protocol::PromptStrategyId::sliding_window() } })]
    #[case::strategy_state_updated(Event::StrategyStateUpdated { payload: StrategyStateUpdated { session_id: SessionId::new(), strategy_id: crate::protocol::PromptStrategyId::compaction(), blob: serde_json::json!({"compaction_count": 0}) } })]
