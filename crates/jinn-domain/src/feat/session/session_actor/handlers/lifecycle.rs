...
impl SessionPersistenceActor {
    ...
    #[allow(clippy::too_many_lines, clippy::items_after_statements, reason = "handler reads best as a single unit")]
...
#[cfg(test)]
mod tests {
    #![allow(clippy::expect_used, clippy::indexing_slicing, clippy::similar_names, reason = "test code")]
