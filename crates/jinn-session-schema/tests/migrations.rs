...
/// A fresh database, after `run_migrations`, contains all five tables plus the
/// `_migrations` tracking row at v20.
#[test]
fn fresh_database_has_all_tables_and_v20() {
    ...
    // Then all five application tables exist.
    ...
    assert_eq!(version, 20, "migration version");
}
