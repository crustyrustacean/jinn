...
mod tests {
    ...
    fn estimate_entry_tokens_for_pinned_system_is_nonzero() {
        ...
        let estimator = CharRatioEstimator;
        let entry = nullslop_protocol::ChatEntry::system("important instruction")
            .with_pin(nullslop_protocol::PinPosition::Top);
    ...
    fn estimate_entry_tokens_for_pinned_actor_is_nonzero() {
        ...
        let estimator = CharRatioEstimator;
        let entry = nullslop_protocol::ChatEntry::actor("echo", "HELLO")
            .with_pin(nullslop_protocol::PinPosition::Relative);
