...
/// [`ActorRef<M>`](crate::actor::ActorRef). Stored in
...
pub struct RoutingEntry {
    ...
    pub send_system: Box<dyn Fn(crate::actor::SystemMessage) + Send + Sync>,
...
#[cfg(test)]
mod tests {
    use crate::actor::{ActorEnvelope, ActorRef};
    use kanal::Receiver;
    ...
    fn send_system_closure_wraps_and_delivers() {
        ...
        (entry.send_system)(crate::actor::SystemMessage::ApplicationReady);
        ...
        assert!(matches!(
            msg,
            ActorEnvelope::System(crate::actor::SystemMessage::ApplicationReady)
        ));
    }
}
