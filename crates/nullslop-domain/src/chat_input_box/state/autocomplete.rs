...
pub struct AutocompleteState {
    ...
    pub(super) matches: Vec<crate::chat_input_box::AutocompleteMatch>,
}
...
impl AutocompleteState {
    ...
    #[must_use]
    pub fn matches(&self) -> &[crate::chat_input_box::AutocompleteMatch] {
        &self.matches
    }

    /// Returns the currently selected match, if any.
    #[must_use]
    pub fn selected_match(&self) -> Option<&crate::chat_input_box::AutocompleteMatch> {
    ...
    pub fn set_matches(&mut self, matches: Vec<crate::chat_input_box::AutocompleteMatch>) {
