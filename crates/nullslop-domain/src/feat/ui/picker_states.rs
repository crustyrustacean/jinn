...
pub trait PickerExt {
    ...
    fn session_picker(&self) -> &nullslop_selection_widget::TreePickerState<SessionTreeEntry>;
    /// Mutable access to the session picker state.
    fn session_picker_mut(&mut self) -> &mut nullslop_selection_widget::TreePickerState<SessionTreeEntry>;

    // --- Persona picker ---

    /// Read-only access to the persona picker state.
    fn persona_picker(&self) -> &nullslop_selection_widget::SelectionState<PersonaEntry>;
    /// Mutable access to the persona picker state.
    fn persona_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<PersonaEntry>;

    // --- Theme picker ---

    /// Read-only access to the theme picker state.
    fn theme_picker(&self) -> &nullslop_selection_widget::SelectionState<ThemeEntry>;
    /// Mutable access to the theme picker state.
    fn theme_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<ThemeEntry>;
    ...
    fn tool_picker(&self) -> &nullslop_selection_widget::SelectionState<ToolEntry>;
    /// Mutable access to the tool picker state.
    fn tool_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<ToolEntry>;
    ...
    fn skill_picker(&self) -> &nullslop_selection_widget::SelectionState<SkillEntry>;
    /// Mutable access to the skill picker state.
    fn skill_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<SkillEntry>;
    ...
    fn session_lifecycle_picker(&self) -> &nullslop_selection_widget::SelectionState<SessionLifecycleEntry>;
    /// Mutable access to the session lifecycle picker state.
    fn session_lifecycle_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<SessionLifecycleEntry>;

    // --- Workflow picker ---

    /// Read-only access to the workflow picker state.
    fn workflow_picker(&self) -> &nullslop_selection_widget::SelectionState<WorkflowPickerEntry>;
    /// Mutable access to the workflow picker state.
    fn workflow_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<WorkflowPickerEntry>;

    // --- Judge picker ---

    /// Read-only access to the judge picker state.
    fn judge_picker(&self) -> &nullslop_selection_widget::SelectionState<JudgePickerEntry>;
    /// Mutable access to the judge picker state.
    fn judge_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<JudgePickerEntry>;

    // --- Compaction model picker ---

    /// Read-only access to the compaction model picker state.
    fn compaction_model_picker(&self) -> &nullslop_selection_widget::SelectionState<PickerEntry>;
    /// Mutable access to the compaction model picker state.
    fn compaction_model_picker_mut(&mut self) -> &mut nullslop_selection_widget::SelectionState<PickerEntry>;
}
