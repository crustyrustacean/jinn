...
use nullslop_web_fetch::{FetchOptions, OutputFormat, WebFetcher};
...
mod tests {
    ...
    use nullslop_web_fetch::{FetchOptions, FetchOutput, WebFetcher};
    ...
    impl WebFetcher for MockFetcher {
        ...
        ) -> Result<FetchOutput, nullslop_web_fetch::FetchError> {
            if self.success {
                Ok(FetchOutput {
                ...
                Err(nullslop_web_fetch::FetchError::Network)
            }
        }
    }
