//! Chat entry selection and related intent validators.
//!
//! Validators for chat entry navigation, pinning, model refresh, prompt template
//! rescan, and session creation intents.
