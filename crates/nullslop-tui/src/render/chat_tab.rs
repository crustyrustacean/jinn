...
pub(super) fn render_chat_tab(
    ...
    border::render_border(frame, layout.border, sidebar_focused, theme.focus_accent, theme.border_unfocused);
    ...
    // Chat bottom line.
    chat_bottom_line::render_chat_bottom_line(frame, content_area, focus_scope, theme.focus_accent, theme.border_unfocused);
