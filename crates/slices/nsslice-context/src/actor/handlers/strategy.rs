...
impl PromptAssemblyActor {
    ...
    pub(in crate::actor) fn on_prompt_strategy_switched(&mut self, evt: &PromptStrategySwitched) {
    ...
    pub(in crate::actor) fn handle_switch_prompt_strategy(
        &self,
    ...
    pub(in crate::actor) fn handle_restore_strategy_state(
        &self,
        payload: &RestoreStrategyState,
        ctx: &ActorContext,
    ) {
