...
impl SessionPersistenceActor {
    ...
    pub(in crate::actor) fn handle_enqueue_user_message(
        &self,
    ...
    pub(in crate::actor) fn handle_set_chat_input_text(&self, payload: &SetChatInputText) {
        let mut state = self.state.write();
        let session = state.session_mut_or_create(&payload.session_id);
    ...
    pub(in crate::actor) fn handle_push_chat_entry(
        &self,
    ...
    pub(in crate::actor) fn handle_push_tool_result(&self, payload: &PushToolResult) {
        let mut state = self.state.write();
        let session = state.session_mut_or_create(&payload.session_id);
    ...
    pub(in crate::actor) fn handle_send_message(payload: &SendMessage, ctx: &ActorContext) {
    ...
    pub(in crate::actor) fn handle_session_load_completed(
        &self,
