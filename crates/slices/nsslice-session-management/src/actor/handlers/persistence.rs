...
use nullslop_protocol::{Command, PromptStrategyId, SessionLoadRequested, SessionSaveRequested};
...
impl SessionPersistenceActor {
    ...
    /// the user experience.
    pub(in crate::actor) fn on_save_requested(&mut self, evt: &SessionSaveRequested) {
    ...
    pub(in crate::actor) fn on_load_requested(
        &mut self,
